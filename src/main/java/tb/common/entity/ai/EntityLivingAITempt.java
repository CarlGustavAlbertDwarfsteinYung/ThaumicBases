...
public class EntityLivingAITempt extends EntityAIBase
{
    ...
    private Item tempt_item;
    /** Whether the entity using this AI will be scared by the tempter's sudden movement. */
    private boolean scaredByPlayerMovement;
    private boolean field_75286_m;
    private static final String __OBFID = "CL_00001616";

    public EntityLivingAITempt(EntityLiving entity, double p_i45316_2_, Item tempt_item, boolean p_i45316_5_)
    {
        this.temptedEntity = entity;
        this.field_75282_b = p_i45316_2_;
        this.tempt_item = tempt_item;
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                return itemstack == null ? false : ((itemstack.getItem() == this.tempt_item) && temptingPlayer.isUsingItem() && itemstack.getItemDamage() == 8);
            }
        }
    }
