...
public class TBThaumonomicon {
    ...
    public static void setup() {
        ...
        InfusionRecipe ukuleleRec = new InfusionRecipe("TB.Ukulele",new ItemStack(TBItems.ukulele),5,new AspectList().add(Aspect.SENSES, 64).add(Aspect.ENERGY, 64).add(Aspect.MAN, 32).add(Aspect.TOOL, 48),new ItemStack(ConfigBlocks.blockMagicalLog,1,0),new ItemStack[]{
                ...
                new ItemStack(Blocks.noteblock),
                new ItemStack(ConfigBlocks.blockWoodenDevice,1,1),
                new ItemStack(ConfigItems.itemJarFilled,1,0)
        });
        ...
        InfusionRecipe knowledgeUkuleleRec = new InfusionRecipe("TB.Ukulele.Knowledge",new ItemStack(TBItems.ukulele,1,1),4,new AspectList().add(Aspect.MIND, 72).add(Aspect.AURA, 18),new ItemStack(TBItems.ukulele,0),new ItemStack[]{
                ...
                new ItemStack(ConfigItems.itemResource,1,9),
                new ItemStack(ConfigItems.itemThaumonomicon,1,0),
                new ItemStack(ConfigItems.itemResource,1,9),
                new ItemStack(ConfigItems.itemInkwell,1,OreDictionary.WILDCARD_VALUE),
                new ItemStack(ConfigItems.itemResource,1,9),
                new ItemStack(ConfigItems.itemThaumonomicon,1,0),
        ...
        InfusionRecipe sanityUkuleleRec = new InfusionRecipe("TB.Ukulele.Sanity",new ItemStack(TBItems.ukulele,1,2),6,new AspectList().add(Aspect.AURA, 48).add(Aspect.LIFE, 36).add(Aspect.ORDER, 64).add(Aspect.MIND, 12),new ItemStack(TBItems.ukulele,0),new ItemStack[]{
                ...
                new ItemStack(ConfigItems.itemResource,1,14),
                new ItemStack(ConfigItems.itemBucketPure,1,0),
                new ItemStack(ConfigItems.itemResource,1,14),
                new ItemStack(ConfigItems.itemBathSalts),
                new ItemStack(ConfigItems.itemResource,1,14),
                new ItemStack(ConfigItems.itemBucketPure,1,0),
        ...
        InfusionRecipe electricUkuleleRec = new InfusionRecipe("TB.Ukulele.Electric",new ItemStack(TBItems.ukulele,1,3),3,new AspectList().add(Aspect.AURA, 16).add(Aspect.AIR, 36).add(Aspect.ENERGY, 64).add(Aspect.ENTROPY, 12).add(Aspect.WEATHER, 24),new ItemStack(TBItems.ukulele,0),new ItemStack[]{
                new ItemStack(ConfigItems.itemFocusShock,1,0),
                new ItemStack(TBBlocks.crystalBlock,1,5),
        ...
        InfusionRecipe resistanceUkuleleRec = new InfusionRecipe("TB.Ukulele.Resistance",new ItemStack(TBItems.ukulele,1,4),8,new AspectList().add(Aspect.AURA, 64).add(Aspect.ARMOR, 48).add(Aspect.LIFE, 64).add(Aspect.EXCHANGE, 36),new ItemStack(TBItems.ukulele,0),new ItemStack[]{
        ...
        InfusionRecipe confusionUkuleleRec = new InfusionRecipe("TB.Ukulele.Confusion",new ItemStack(TBItems.ukulele,1,6),5,new AspectList().add(Aspect.AURA, 48).add(Aspect.DEATH, 24).add(Aspect.ENTROPY, 36).add(Aspect.MIND, 24),new ItemStack(TBItems.ukulele,0),new ItemStack[]{
                ...
                new ItemStack(ConfigItems.itemBucketDeath,1,0),
        ...
        new FakeResearchItem("TB.ARCANEEAR", "THAUMICBASES", "ARCANEEAR", "ARTIFICE", -10,-16, new ItemStack(ConfigBlocks.blockWoodenDevice,1,1)).registerResearchItem();
        ...
        new ResearchItem("TB.Ukulele.Electric",catName,new AspectList().add(Aspect.ENERGY, 3).add(Aspect.WEATHER, 3).add(Aspect.FIRE, 3),-15,-13,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/ukulele/electric.png"))
                .setSecondary()
                .setParents("TB.Ukulele")
                .setPages(
        ...
        new ResearchItem("TB.Ukulele.Resistance",catName,new AspectList().add(Aspect.ARMOR, 3).add(Aspect.EARTH, 3).add(Aspect.METAL, 3),-14,-12,0,new ResourceLocation("thaumicbases","textures/thaumonomicon/ukulele/resistance.png"))
                .setSecondary()
                .setParents("TB.Ukulele")
                .setPages(
        ...
        if (TBConfig.enableNodeTools) {
            ...
            new ResearchItem("TB.HerobrinesScythe",catName,new AspectList().add(Aspect.ELDRITCH, 16).add(Aspect.DEATH, 16).add(Aspect.WEAPON, 16).add(Aspect.AURA, 8).add(Aspect.ENERGY, 6),17,1,4,new ItemStack(TBItems.herobrinesScythe,1,0))
                    .setParents("TB.VOIDMETAL")
                    .setSpecial()
                    .setPages(
